 ...
 * must be selected or switched at run-time.</p>
 * <p>
 * - Both the abstractions and their implementations should be extensible by
 * sub-classing. In this case, the Bridge pattern lets you combine the different
 * abstractions and implementations and extend them independently.</p>
 * <p>
 * Changes in the implementation of an abstraction should have no impact on
 * clients; that is, their code should not have to be recompiled.</p>
 * <p>
 * You want to share an implementation among multiple objects (perhaps using
 * reference counting), and this fact should be hidden rom the client.</p>
 *
 */
